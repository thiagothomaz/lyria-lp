          ...
          <div className="grid lg:grid-cols-12 gap-12 items-center h-full">
            ...
            >
              ...
              >
                ...
                prescrição para sua caneta de emagrecimento.{" "}
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-4xl md:text-5xl font-bold mb-12 text-white">
              Tem dúvidas? A Lyria responde para você.
            </h2>
          ...
          <Accordion type="single" collapsible className="w-full space-y-4">
            {[
              ...
              <AccordionItem
                key={idx}
                value={`item-${idx}`}
                className="bg-white border border-gray-200 rounded-xl px-6 shadow-sm data-[state=open]:border-primary/50 transition-all"
              >
